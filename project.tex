...
Nielson and Nielson define the state function as being of type $\Var \rightarrow \mathbb{Z}$, so we need to redefine it. We have two types of variables: \textbf{Avar} and \textbf{Lexp}, so we also have two state functions.
