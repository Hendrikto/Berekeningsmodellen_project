...
Nielson and Nielson define the state function as being of type $\mathbf{Var} \rightarrow \mathbb{Z}$, so we need to redefine it. We have two types of variables: \textbf{Avar} and \textbf{Lexp}, so we also have two state functions.

\begin{itemize}
    \item $Astate: \mathbf{Avar} \rightarrow \mathbb{Z}$
    ...
    \item $Lstate: \mathbf{Lvar} \rightarrow \mathbb{N} \rightarrow \mathbb{Z}$
