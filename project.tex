...
$\begin{aligned}
    \fancybr{\CC}{[\text{a for x in l}]} s &= \fancybr{\CC}{[\text{a for x in l if true}]} s\\
    ...
    \fancybr{\CC}{[\text{a for x in h:t if b}]} s &= \begin{cases}
        ...
        & \text{if } \fancybr{\BB}{b} s[x \mapsto h] = \mathbf{tt}\\
        \fancybr{\CC}{[\text{a for x in t if b}]} s
        & \text{if } \fancybr{\BB}{b} s[x \mapsto h] = \mathbf{ff}\\
    \end{cases}\\
\end{aligned}$
